                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($post->is_approved == false)
                                                    <form class="approvePost" action="{{ route('admin.post.approve', $post->id) }}" method="POST">
                                                        ...
                                                        {{-- <button type="submit" value="Approve" class="btn btn-danger waves-effect" style="float: right; width: 72px; border: 3px solid light-red; padding: 8px; margin-left: 10px;"> --}}
                                                            <button type="submit" value="Approve" class="btn btn-danger waves-effect" style="float: left;  width: 28px; padding: 1px; margin-right: 10px; border: 3px solid light-red; margin-left: 10px;">
                                                ...
                                                {{-- <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-info waves-effect"  style="float: left; height: 40px; width: 67px; border: 3px solid light-red;"> --}}
                                                    <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-info waves-effect"  style="float: right;  width: 28px; padding: 1px; margin-left: 10px; border: 3px solid light-red; ">
                                                ...
                                                {{-- <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-info waves-effect"  style="float: left; height: 40px; width: 67px; border: 3px solid light-red;"> --}}
                                                    <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-info waves-effect"  style="float: right;  width: 28px; padding: 1px; margin-right: 110px; border: 3px solid light-red; ">
                                                ...
                                                <form class="delete" action="{{ route('admin.post.destroy', $post->id) }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                        ...
                                                        {{-- <button type="submit" value="Delete" class="btn btn-danger waves-effect" style="float: right; width: 72px; border: 3px solid light-red; padding: 8px; margin-left: 10px;"> --}}
                                                            <button type="submit" value="Delete" class="btn btn-danger waves-effect" style="float: center;  width: 28px; padding: 1px; border: 3px solid light-red; ">
