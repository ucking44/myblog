            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <lable for="image">Featured Image</lable>
                        <input type="file" name="image">
                    </div>

                    <div class="form-group">
                        <input class="filled-in" type="checkbox" name="status" value="1" {{ $post->status == true ? 'checked' : '' }} id="publish">
                        <label for="publish">
                            Publish
                        </label>
                    </div>
